...
namespace ExcellData.Controllers
{
    public class HomeController : Controller
    {
        private readonly ExcellEntities _context = new ExcellEntities();
       ...
       public ActionResult index()
        ...
        public ActionResult Upload(HttpPostedFileBase file)
        {
            ...
            return RedirectToAction("Index"); // Or any other view
        }
    }
}